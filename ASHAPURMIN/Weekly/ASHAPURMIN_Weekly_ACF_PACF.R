...
weekly_prices <- to.weekly(ASHAPURMIN)
...
acf_plot <- acf(Returns_ts, main = "Autocorrelation Function (ACF) for ASHAPURMIN Weekly Returns",
...
pacf_plot <- pacf(Returns_ts, main = "Partial Autocorrelation Function (PACF) for ASHAPURMIN Weekly Returns",
     lag.max = 52,
     ci.col = "blue")
dev.off()
