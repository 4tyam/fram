...
monthly_prices <- to.monthly(ASHAPURMIN)
...
acf_plot <- acf(Returns_ts, main = "Autocorrelation Function (ACF) for ASHAPURMIN Monthly Returns",
...
pacf_plot <- pacf(Returns_ts, main = "Partial Autocorrelation Function (PACF) for ASHAPURMIN Monthly Returns",
     lag.max = 24,
     ci.col = "blue")
dev.off()
