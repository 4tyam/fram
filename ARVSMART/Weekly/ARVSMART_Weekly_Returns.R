...
weekly_prices <- to.weekly(ARVSMART)  # Convert to weekly OHLC
...
ggplot(Returns_df, aes(x = Date, y = Returns)) +
  ...
  theme_minimal() +
  labs(
    title = "Weekly Returns of State Bank of India (ARVSMART.NS)",
    x = "Date",
    y = "Returns",
...
ggsave("ARVSMART_Weekly_Returns.png", width = 12, height = 6, dpi = 300)
