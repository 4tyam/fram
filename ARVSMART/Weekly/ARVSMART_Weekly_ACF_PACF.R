...
weekly_prices <- to.weekly(ARVSMART)
...
acf_plot <- acf(Returns_ts, main = "Autocorrelation Function (ACF) for ARVSMART Weekly Returns",
...
pacf_plot <- pacf(Returns_ts, main = "Partial Autocorrelation Function (PACF) for ARVSMART Weekly Returns",
     lag.max = 52,
     ci.col = "blue")
dev.off()
