...
monthly_prices <- to.monthly(ARVSMART)
...
acf_plot <- acf(Returns_ts, main = "Autocorrelation Function (ACF) for ARVSMART Monthly Returns",
...
pacf_plot <- pacf(Returns_ts, main = "Partial Autocorrelation Function (PACF) for SARVSMARTBI Monthly Returns",
     lag.max = 24,
     ci.col = "blue")
dev.off()
