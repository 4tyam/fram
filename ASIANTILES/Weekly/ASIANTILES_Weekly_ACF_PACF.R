...
weekly_prices <- to.weekly(ASIANTILES)
...
acf_plot <- acf(Returns_ts, main = "Autocorrelation Function (ACF) for ASIANTILES Weekly Returns",
...
pacf_plot <- pacf(Returns_ts, main = "Partial Autocorrelation Function (PACF) for ASIANTILES Weekly Returns",
     lag.max = 52,
     ci.col = "blue")
dev.off()
