...
weekly_prices <- to.weekly(AROGRANITE)  # Convert to weekly OHLC
...
ggplot(Returns_df, aes(x = Date, y = Returns)) +
  ...
  theme_minimal() +
  labs(
    title = "Weekly Returns of State Bank of India (AROGRANITE.NS)",
    x = "Date",
    y = "Returns",
...
ggsave("AROGRANITE_Weekly_Returns.png", width = 12, height = 6, dpi = 300)
