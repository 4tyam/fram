...
acf_plot <- acf(Returns_ts, main = "Autocorrelation Function (ACF) for AROGRANITE Daily Returns",
...
pacf_plot <- pacf(Returns_ts, main = "Partial Autocorrelation Function (PACF) for AROGRANITE Daily Returns",
     lag.max = 30,
     ci.col = "blue")
dev.off()
